                ...
                <td>
                  <div class="proposal-row">
                    ...
                    <div class="proposal-icon"
                         style="background:<?php echo $p->icon_color ?? 'var(--accent-dim)'; ?>;">
                      <span style="font-size:.8125rem;font-weight:700;
                                   color:<?php echo $p->icon_text_color ?? 'var(--accent)'; ?>;">
...
const chartData = {
    days: <?php echo json_encode($chartDays); ?>,
    vals: <?php echo json_encode($chartViews); ?>,
};
